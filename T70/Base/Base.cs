...
namespace ECard78
{
  public struct SystemInfo
  {
    ...
    public static string AppVersion = "V70.1.0";
    ...
    public static bool AllowCardWarn = true;
    ...
    public static bool AllowCustomerCardNo = true;
    ...
    public const int WanInterval = 30000;
    public const int WaterFlag = 2;
    ...
    public static int IsLongEmpID = 0;
  ...
  {
    public static QHAPI.AES objAES = null;
    public static QHAPI.DES objDES = null;
    public static QHAPI.CPIC objCPIC = null;
    public static QHAPI.Card objCard = null;
  ...
  public class Base
  {
    ...
    public bool ReadCardInfo(ref QHAPI.TCardPubData pubData, ref QHAPI.TCardSFData sfData)
    {
      ...
      int cardRet = DeviceObject.objCPIC.ReadCardInfo(ref DataFlag, ref pubData, ref sfData, ref skData, 0);
      if (cardRet != 0)
      {
    ...
    public bool ReadCardInfo(ref QHAPI.TCardSFData sfData)
    {
      if (SystemInfo.CardKey == "")
      {
        MessageBoxShow(GetResText("", "ErrorCardkey", ""));
    ...
    public bool ReadCardInfo(ref QHAPI.TCardPubData pubData)
    {
      if (SystemInfo.CardKey == "")
      {
        MessageBoxShow(GetResText("", "ErrorCardkey", ""));
      ...
      int cardRet = DeviceObject.objCPIC.ReadCardInfoPub(ref pubData);
      if (cardRet != 0)
      {
        MessageBoxShow(GetCardMsg(cardRet));
        return false;
    ...
    public bool ReadCardInfo(ref QHAPI.TCardPubData pubData, ref string ErrorMsg)
    {
      ErrorMsg = "";
      if (SystemInfo.CardKey == "")
      {
    ...
    public bool ReadCardInfo(ref QHAPI.TCardSKData skData)
    {
    ...
    public bool ReadCardInfo(ref QHAPI.TCardSKData skData, ref string ErrorMsg)
    {
      ErrorMsg = "";
      int cardRet = DeviceObject.objCPIC.ReadCardSKInfo(ref skData);
      if (cardRet != 0)
    ...
    public int WriteCardInfo(QHAPI.TCardPubData pubData, QHAPI.TCardSFData sfData, QHAPI.TCardSKData skData)
    {
      if (!SystemInfo.HasSK)
        return DeviceObject.objCPIC.WriteCardInfo(ref pubData, ref sfData, ref skData, 0);
      else
        return DeviceObject.objCPIC.WriteCardInfo(ref pubData, ref sfData, ref skData, SystemInfo.WaterFlag);
    }

    public int WriteCardInfo(QHAPI.TCardPubData pubData)
    {
      return DeviceObject.objCPIC.WriteCardInfoPub(ref pubData);
    }

    public int WriteCardInfo(QHAPI.TCardSFData sfData)
    {
      return DeviceObject.objCPIC.WriteCardInfoSF(ref sfData);
    }

    public int WriteCardInfo(QHAPI.TCardSKData skData)
    {
    ...
    public string GetMJReaderID(string MacSN, int ReaderID)
    {
      ...
      if ((MacSN.Substring(0, 2) == "01") || (MacSN.Substring(0, 2) == "02"))
      {
        if (ReaderID == 1)
          ret = "1-1";
        else if (ReaderID == 2)
    ...
    public void ClearCardLimitInfo(DateTime dt, ref QHAPI.TCardSFData sfData)
    {
      DateTime d1 = new DateTime(dt.Year, dt.Month, dt.Day);
  ...
  public class Database
  {
    ...
    public void ReadSystemConfig()
    {
      ...
      //人员编号数字位
      SystemInfo.EmpNoNumBit = ReadConfig("RS_System", "EmpNoNumBit", Convert.ToByte(4));
      //公共扇区
