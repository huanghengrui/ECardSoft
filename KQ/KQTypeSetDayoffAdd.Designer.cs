namespace ECard78
{
  partial class frmKQTypeSetDayoffAdd
  {
    /// <summary>
    /// 必需的设计器变量。
    /// </summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.chkGS.Location = new System.Drawing.Point(10, 70);
      this.chkGS.Name = "chkGS";
      this.chkGS.Size = new System.Drawing.Size(78, 16);
      this.chkGS.TabIndex = 2;
      this.chkGS.Tag = "DayOffIsGS";
      this.chkGS.Text = "checkBox1";
      ...
      this.label2.Tag = "DayOffTypeName";
      ...
      // 
      // frmKQTypeSetDayoffAdd
      // 
      this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 12F);
      this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
      this.ClientSize = new System.Drawing.Size(259, 128);
      this.Controls.Add(this.chkGS);
      this.Controls.Add(this.txtName);
      this.Controls.Add(this.label2);
      this.Controls.Add(this.label1);
      this.Controls.Add(this.txtNo);
      this.Name = "frmKQTypeSetDayoffAdd";
      this.Text = "KQTypeSetDayoffAdd";
      ...
      this.Controls.SetChildIndex(this.chkGS, 0);
