    ...
    public string GetSQL(DBCode code, string[] Param)
    {
      ...
      switch (code)
      {
        ...
        case DBCode.DB_001001:
          ...
          switch (I)
          {
            ...
            case 102:
              ...
              break;
            case 103:
              ret = "INSERT INTO RS_DepositDiscount(GUID,CardTypeSysID,DiscStart,DiscEnd,DiscDiscount) " +
                "VALUES(newid(),'" + Param[1] + "'," + Param[2] + "," + Param[3] + "," + Param[4] + ")";
              break;
            case 104:
              ret = "UPDATE RS_DepositDiscount SET CardTypeSysID='" + Param[1] + "',DiscStart=" + Param[2] +
                ",DiscEnd=" + Param[3] + ",DiscDiscount=" + Param[4] + " WHERE GUID='" + Param[5] + "'";
              break;
            case 105:
        ...
        case DBCode.DB_001002:
          ...
          switch (I)
          {
            ...
            case 7:
              ...
              break;
            case 8:
              ret = "SELECT * FROM VRS_Emp WHERE DepartSysID='" + Param[1] + "'";
          ...
          switch (I)
          {
            ...
            case 8:
              ret = "INSERT INTO RS_Emp(EmpSysID,EmpNo,EmpName,EmpSexSysID,CardTypeSysID,DepartSysID,EmpHireDate," +
                ...
                "FingerPrivilege) VALUES('" + Param[1] + "','" + Param[2] + "','" + Param[3] + "','" +
            ...
            case 205:
              ret = "INSERT INTO RS_Emp(EmpSysID,EmpNo,EmpName,EmpSexSysID,CardTypeSysID,DepartSysID,EmpHireDate," +
                "EmpCertNo,EmpAddress,EmpZipNo,EmpPhoneNo,EmpEmail,IsAttend,OtherCardNo) VALUES(newid(),'" +
            ...
            case 218:
              ...
              break;
            case 219:
              ret = "SELECT * FROM VRS_Emp WHERE CardTypeID=" + Param[1];
              if (Param.Length > 3) ret += Param[2] + Param[3];
              ret += " ORDER BY EmpNo";
              break;
            case 220:
            ...
            case 226:
              ...
              break;
            case 227:
              ret = "SELECT a.SFCardBalance FROM VSF_SFData a " +
        ...
        case DBCode.DB_002001:
          ...
          switch (I)
          {
            ...
            case 3005:
              ...
              break;
            case 4000:
              ret = "SELECT * FROM VKQ_EmpPsssTime ORDER BY EmpNo";
              break;
            case 4001:
        ...
        case DBCode.DB_004003:
          ...
          {
            case 0:
              ret = "SELECT * FROM VSF_MacProducts ORDER BY ProductsID";
              break;
            case 1:
              ret = "INSERT INTO SF_MacProducts(GUID,ProductsID,ProductsName,ProductsPrice) VALUES(newid()," +
                Param[1] + ",'" + Param[2] + "'," + Param[3] + ")";
              break;
            case 2:
              ret = "UPDATE SF_MacProducts SET ProductsID=" + Param[1] + ",ProductsName='" + Param[2] +
                "',ProductsPrice=" + Param[3] + " WHERE GUID='" + Param[4] + "'";
              break;
            case 3:
            ...
            case 4:
              ...
              break;
            case 5:
              ret = "SELECT * FROM SF_MacProducts WHERE ProductsID=" + Param[1];
              break;
            case 6:
              ret = "SELECT * FROM SF_MacProducts WHERE GUID<>'" + Param[1] + "' AND ProductsID=" + Param[2];
              break;
            case 101:
          ...
          switch (I)
          {
            ...
            case 106:
              ...
              if (Param[1] == "")
                ...
                ret += "ProductsID IN(" + Param[1] + ") ORDER BY ProductsID";
              break;
            case 107:
            ...
            case 111:
              ...
              break;
            case 112:
              ret = "SELECT CAST(CASE WHEN ProductsID IN(" + Param[1] + ") THEN 1 ELSE 0 END AS bit) AS SelectCheck," +
                "ProductsID,ProductsName,ProductsPrice,GUID FROM SF_MacProducts ORDER BY ProductsID";
              break;
            case 113:
          ...
          switch (I)
          {
            case 0:
              ...
              ret = "EXEC PSF_SFDataInsert '" + Param[1] + "'," + Param[2] + ",'" + Param[3] + "'," +
                ...
                Param[14] + "','" + Param[15] + "','" + Param[16] + "'";
              if (Param.Length >= 20)
              {
                if (DateTime.TryParse(Param[17], out d) && DateTime.TryParse(Param[18], out d))
                {
                  s = ",'" + Param[17] + "','" + Param[18] + "'," + Param[19];
                }
                else
                {
                  s = ",NULL,NULL,NULL";
        ...
        case DBCode.DB_004007:
          ...
          switch (I)
          {
            ...
            case 2:
              ...
              break;
            case 3:
              ret = "SELECT COUNT(1) AS CountTimes,ISNULL(SUM(ABS(SFAmount)),0) AS SumSFAmount,SFTypeID " +
                "FROM VSF_SFData WHERE IsAlarm=0";
              if (Param.Length >= 2) ret += " AND SFDate<'" + Param[1] + "'";
              ret += " GROUP BY SFTypeID";
              break;
            case 4:
              ret = "SELECT SUM(ISNULL(CardBalance,0)) AS CardBalance " +
            ...
            case 5:
              ...
              break;
            case 6:
              ret = "SELECT SUM(SFCardBalance) FROM(SELECT DISTINCT a.EmpSysID,a.CardUseTimes,a.SFCardBalance " +
        ...
        case DBCode.DB_004008:
          ...
          s = "SUM(iDSum) AS iDSum,SUM(iDSum0) AS iDSum0,SUM(iDSum1) AS iDSum1,SUM(iDSum2) AS iDSum2," +
            ...
            "SUM(iMDSum8) AS iMDSum8,SUM(iMDSum9) AS iMDSum9,SUM(iBtSum) AS iBtSum,SUM(iICInSum) AS iICInSum," +
            "SUM(iRSum) AS iRSum,SUM(iMRSum) AS iMRSum,SUM(iESum) AS iESum,SUM(iICOutSum) AS iICOutSum," +
            "SUM(ZeroSum) AS ZeroSum,SUM(iInSum) AS iInSum,SUM(iOutSum) AS iOutSum,SUM(iNSum) AS iNSum";
          s2 = "VSF_QueryIncome";
          switch (I)
          {
            case 0:
        ...
        case DBCode.DB_004009:
          ret = "SELECT * FROM VRS_Emp WHERE CardStatusID<>10" + GetEmpInfoSQL(Param[0], Param[1]) +
        ...
        case DBCode.DB_004011:
          ...
          switch (I)
          {
            case 0:
              ...
              break;
            case 1:
              ret = "SELECT * FROM VSF_SFData WHERE SFDate>='" + Param[10] + "' AND SFDate<='" + Param[11] + "'" + Param[12];
              ...
              break;
            case 2:
              ret = "SELECT EmpNo,EmpName,EmpCertNo,EmpPhoneNo,DepartID,DepartName,SFTypeName,SUM(SFAmount) AS SFAmount " +
            ...
            case 10:
              ...
              ret += GetEmpInfoSQL(Param[1], Param[2]) + GetDepartInfoSQL(Param[3], Param[4], Param[5]) + GetCardTypeInfoSQL(Param[6]);
              ret += GetMealTypeInfoSQL(Param[7]) + GetMacSNInfoSQL(Param[8]) + GetAddressInfoSQL(Param[12], Param[13], Param[14]);
              ret += " ORDER BY EmpNo,CardUseTimes";
              break;
            case 11:
              ret = "SELECT ProductsName,SUM(ProductNum) AS ProductNum,SUM(ProductsMoney) AS ProductsMoney " +
                "FROM VSF_SFDataProduct WHERE SFDate>='" + Param[9] + "' AND SFDate<='" + Param[10] + "'" + Param[11];
              ret += GetEmpInfoSQL(Param[1], Param[2]) + GetDepartInfoSQL(Param[3], Param[4], Param[5]) + GetCardTypeInfoSQL(Param[6]);
              ret += GetMealTypeInfoSQL(Param[7]) + GetMacSNInfoSQL(Param[8]) + GetAddressInfoSQL(Param[12], Param[13], Param[14]);
              ret += " GROUP BY ProductsName ORDER BY ProductsName";
              break;
            case 20:
            ...
            case 31:
              ...
              ret = "SELECT " + s + ",SUM(iCZCount1) AS iCZCount1,SUM(iCZCountSum1) AS iCZCountSum1," +
                ...
                "SUM(iCZCount3) AS iCZCount3,SUM(iCZCountSum3) AS iCZCountSum3 FROM ";
              if (Param[1] == "2")
            ...
            case 40:
              ...
              ret = "SELECT " + s + ",SUM(iCount) AS iCount,SUM(iCountSum) AS iCountSum," +
                "SUM(iCountMeal1) AS iCountMeal1,SUM(iCountSumMeal1) AS iCountSumMeal1," +
                "SUM(iCountMeal2) AS iCountMeal2,SUM(iCountSumMeal2) AS iCountSumMeal2," +
                "SUM(iCountMeal3) AS iCountMeal3,SUM(iCountSumMeal3) AS iCountSumMeal3," +
                "SUM(iCountMeal4) AS iCountMeal4,SUM(iCountSumMeal4) AS iCountSumMeal4 " +
            ...
            case 80:
              ...
              if (s1 == "") s1 = s;
              ret = "SELECT " + s + ",SUM(XFCount1) AS XFCount1,SUM(XFSum1) AS XFSum1,SUM(XFCount2) AS XFCount2," +
                "SUM(XFSum2) AS XFSum2,SUM(XFCount3) AS XFCount3,SUM(XFSum3) AS XFSum3,SUM(XFCount4) AS XFCount4," +
                "SUM(XFSum4) AS XFSum4,SUM(XFCount5) AS XFCount5,SUM(XFSum5) AS XFSum5,SUM(XFCount6) AS XFCount6," +
                "SUM(XFSum6) AS XFSum6,SUM(XFCount7) AS XFCount7,SUM(XFSum7) AS XFSum7,SUM(XFCount8) AS XFCount8," +
                "SUM(XFSum8) AS XFSum8,SUM(XFCount9) AS XFCount9,SUM(XFSum9) AS XFSum9,SUM(XFCount10) AS XFCount10," +
                "SUM(XFSum10) AS XFSum10,SUM(XFCount11) AS XFCount11,SUM(XFSum11) AS XFSum11," +
