...
namespace ECard78
{
    public partial class frmSeaDoorCondition : frmBaseDialog
    {

        protected override void InitForm()
        {
            formCode = "SeaDoorCondition";
            base.InitForm();
            ...
            string sql = Pub.GetSQL(DBCode.DB_006001, new string[] { "39" });
            try
            {
        ...
        private void SaveParam()
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    sql = Pub.GetSQL(DBCode.DB_006001, new string[] { "38",MacSN, cbbFaceThreshold.SelectedIndex.ToString(),cbbIDCardThreshold.SelectedIndex.ToString(),
                ...
                {
                    sql = Pub.GetSQL(DBCode.DB_006001, new string[] { "37","1", cbbFaceThreshold.SelectedIndex.ToString(),cbbIDCardThreshold.SelectedIndex.ToString(),
                                cbbOpendoorWay.SelectedIndex.ToString(),((VerifyModeType)cbbVerifyMode.SelectedItem).id.ToString(),cbbWiegand.SelectedIndex.ToString(),cbbControlType.SelectedIndex.ToString(),
                                 txtPublicMjCardNo.Text,txtAutoMjCardBgnNo.Text,txtAutoMjCardEndNo.Text,txtIOStayTime.Text});
                }
