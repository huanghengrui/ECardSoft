...
namespace ECard78
{
    public partial class frmSeaTemperature : frmBaseDialog
    {

        protected override void InitForm()
        {
            formCode = "SeaTemperature";
            base.InitForm();
            ...
            string sql = Pub.GetSQL(DBCode.DB_006001, new string[] { "45" });
            try
            {
        ...
        private void SaveParam()
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    sql = Pub.GetSQL(DBCode.DB_006001, new string[] { "44",MacSN, ((TemperatureType)cbbFaceMaskTPTMode.SelectedItem).id.ToString(),txtTemperatureCheck.Text.ToString(),
                ...
                {
                    sql = Pub.GetSQL(DBCode.DB_006001, new string[] { "43","1", ((TemperatureType)cbbFaceMaskTPTMode.SelectedItem).id.ToString(),txtTemperatureCheck.Text.ToString(),
                                txtTemperatureHigh.Text.ToString(),txtEnvTemperatureCheck.Text.ToString(),txtEnvTemperature.Text.ToString(),cbbOpenLaser.SelectedIndex.ToString()});
                }
